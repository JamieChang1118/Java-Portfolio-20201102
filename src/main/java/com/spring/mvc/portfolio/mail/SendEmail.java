...
public class SendEmail {
    public static void main(String[] args) throws Exception {
        String personal = "Jamie"; // 發送者姓名
        String to = "boddy162002@yahoo.com.tw"; // 發送給誰 ? 若有多筆", "號隔開
        String title = "驗證信"; // 信件 title
        // 信件內容 
        String html = "<h1>加油<h1>";
    ...
    public void submit(String personal, String to, String title, String html) throws Exception {
        ...
        final String googleGmail = "boddy162002@gmail.com"; // 你的 Gmail
        final String authPassword = "owgoydxwuhjvikia"; // 你的授權碼
        ...
        InternetAddress ia = new InternetAddress("boddy162002@gmail.com"); // 你的 Gmail
